    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.headers().frameOptions().disable().and()
                ...
                .authorizeHttpRequests((authz) -> authz
                        ...
                        .antMatchers(HttpMethod.PUT,"/cliente/ativar-inativar").hasAnyRole("CLIENTE", "ADMIN")
                        .antMatchers(HttpMethod.PUT,"/cliente/ativar-inativar-admin").hasRole( "ADMIN")
                        ...
                        .antMatchers(HttpMethod.GET,"/contato/usuario").hasAnyRole("USUARIO", "ADMIN")
                        .antMatchers(HttpMethod.PUT,"/contato").hasAnyRole("USUARIO", "ADMIN")
                        .antMatchers(HttpMethod.POST,"/contato/criar-contato-admin").hasRole("ADMIN")
                        .antMatchers(HttpMethod.POST,"/contato/criar-contato").hasAnyRole("USUARIO", "ADMIN")
                        //ENDERECO
                        .antMatchers(HttpMethod.DELETE,"/endereco").hasAnyRole("USUARIO", "ADMIN")
                        .antMatchers(HttpMethod.GET,"/endereco").hasRole("ADMIN")
                        .antMatchers(HttpMethod.GET,"/endereco/usuario").hasAnyRole("USUARIO", "ADMIN")
                        .antMatchers(HttpMethod.PUT,"/endereco").hasAnyRole("USUARIO", "ADMIN")
                        .antMatchers(HttpMethod.POST,"/endereco/criar-endereco-admin").hasRole("ADMIN")
                        .antMatchers(HttpMethod.POST,"/endereco/criar-endereco").hasAnyRole("USUARIO", "ADMIN")
                        //MENTOR
                        ...
                        .antMatchers(HttpMethod.PUT,"/profissional-mentor/ativar-inativar").hasAnyRole("PROFISSIONAL", "ADMIN")
                        .antMatchers(HttpMethod.PUT,"/profissional-mentor/ativar-inativar-admin").hasRole( "ADMIN")
