...
public class EmailMapper {
    ...
    public static AgendarEmailDTO agendaToAgendaEmailDTO(Agenda agenda) {
        ...
        agendarEmailDTO.setDataHoraInicio(agenda.getDataHoraInicio());
        agendarEmailDTO.setDataHoraFim(agenda.getDataHoraFim());
