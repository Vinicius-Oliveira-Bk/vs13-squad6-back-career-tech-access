...
CREATE TABLE ESTUDANTE (
	...
	comprovante_matricula VARCHAR2(255) NOT NULL,
...
CREATE TABLE PROFISSIONAL_MENTOR (
    ...
    CONSTRAINT PK_PROFISSIONAL_CLIENTE FOREIGN KEY (id_usuario) REFERENCES USUARIO(id)
);
...
------------------------------------
-- VINCULO DE CLIENTE COM CONTATO
